...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <xsl:param name="orgType"/>
	<xsl:template match="/">
		<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:oper="urn:v3.webservices.operations.flexnet.com">
			<soapenv:Header />
			<soapenv:Body>
				<oper:getUsersQueryRequest>
					<oper:queryParams>
						...
						<oper:accountType><xsl:value-of select="$orgType"/></oper:accountType>
					</oper:queryParams>
